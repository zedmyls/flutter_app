...
import 'package:flutter_app/app/modules/tabs/shopcart/cart_item/controllers/cart_item_controller.dart';
...
class CartItemView extends StatelessWidget {
  ...
  CartItemController get _controller => Get.find(tag: item.goodsId!.id_);
                          ...
                          Row(
                            children: <Widget>[
                              Visibility(
                                child: InkWell(
                                  onTap: () {
                                    _controller.changeGoodsNum(item.goodsId!.id_!, false);
                                  },
                                ...
                                visible: _controller.goodsNum > 1,
                              ),
                              SizedBox(
                                width: 4,
                              ),
                              Card(
                                child: Padding(
                                  ...
                                  child: Text('${_controller.goodsNum}'),
                                ),
                              ),
                              SizedBox(
                                width: 4,
                              ...
                              Visibility(
                                child: InkWell(
                                  onTap: () {
                                    _controller.changeGoodsNum(item.goodsId!.id_!, true);
                                  },
                                ...
                                visible: _controller.goodsNum < 99,
                              ),
                            ],
                          )
                        ],
